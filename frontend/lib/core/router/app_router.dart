...
final goRouterProvider = Provider<GoRouter>((ref){
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      final isGoingToPublicRoute = state.uri.toString().startsWith('/products') || 
    ...
    routes: [
      ...
      GoRoute(
        path: '/select-role',
        builder: (context, state) => const Scaffold(body: Center(child: Text('Select Role Screen'))),
      ),
      GoRoute(
        path: '/profile',
      ...
      GoRoute(
        path: '/products',
        builder: (context, state) => const Scaffold(body: Center(child: Text('Product Catalog (Public)'))),
      ),
      GoRoute(
        path: '/reviews',
        builder: (context, state) => const Scaffold(body: Center(child: Text('App Reviews (Public)'))),
      ),
    ],
  );
});